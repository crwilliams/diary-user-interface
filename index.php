...
$content .= "<div class='box sidebox' id='calendar-search'><div class='header'>Search by date</div><div class='content'><a href='#' id='alldates' class='view-events'>View full calendar</a></div></div>";
...
$content .= "<div class='box mainbox' id='main'><div class='header'><h1>Events Calendar</h1><a id='view-all' class='view-events right'>View all events</a></div><div class='content'><b class='homepage-only'>Upcoming Events</b>".getEventListings($events)."<a href='#' class='view-events right homepage-only'>View all events</a></div></div>";
