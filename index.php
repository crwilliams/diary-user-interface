...
$content .= "<div class='box mainbox' id='main'><div class='header'><h1>Events Calendar</h1><a id='view-all' class='right'>View all events</a></div><div class='content'><b>Upcoming Events</b>".getEventListings($events)."</div></div>";
